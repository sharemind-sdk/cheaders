...
int main() {
    const uint64_t nopHalt[] = {
        SVM_BYTES_TO_UINT64(0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00), // NOP
        SVM_BYTES_TO_UINT64(0x00,0xff,0x00,0x00,0x00,0x00,0x00,0x00), // HALT
        SVM_BYTES_TO_UINT64(0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff)  // return code (255)
    };
