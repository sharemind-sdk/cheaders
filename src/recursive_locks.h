...
#define SHAREMIND_NAMED_RECURSIVE_LOCK_FUNCTIONS_DECLARE(CN,inlinePerhaps,FunName,...) \
    SHAREMIND_NAMED_RECURSIVE_LOCK_FUNCTIONS_DECLARE__(CN,inlinePerhaps,lock,FunName,SHAREMIND_WRAP(__VA_ARGS__)) \
    SHAREMIND_NAMED_RECURSIVE_LOCK_FUNCTIONS_DECLARE__(CN,inlinePerhaps,unlock,FunName,SHAREMIND_WRAP(__VA_ARGS__))
