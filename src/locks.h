...
#define SHAREMIND_NAMED_LOCK_FUNCTIONS_DECLARE_(CN,inlinePerhaps,f,FunName,...) \
...
#define SHAREMIND_NAMED_LOCK_FUNCTIONS_DECLARE(CN,inlinePerhaps,FunName,...) \
    SHAREMIND_NAMED_LOCK_FUNCTIONS_DECLARE_(CN,inlinePerhaps,lock,FunName,SHAREMIND_WRAP(__VA_ARGS__)) \
    SHAREMIND_NAMED_LOCK_FUNCTIONS_DECLARE_(CN,inlinePerhaps,unlock,FunName,SHAREMIND_WRAP(__VA_ARGS__))
...
#define SHAREMIND_NAMED_LOCK_FUNCTIONS_DEFINE_(CN,inlinePerhaps,f,FunName,mutexName) \
    SHAREMIND_EXTERN_C_BEGIN \
    inlinePerhaps void CN ## _ ## f ## FunName(CN * c) { \
        assert(c); \
...
#define SHAREMIND_NAMED_LOCK_FUNCTIONS_DEFINE(CN,inlinePerhaps,FunName,mutexName) \
    SHAREMIND_NAMED_LOCK_FUNCTIONS_DEFINE_(CN,inlinePerhaps,lock,FunName,mutexName) \
    SHAREMIND_NAMED_LOCK_FUNCTIONS_DEFINE_(CN,inlinePerhaps,unlock,FunName,mutexName)
